...
\author{Adam Seewald${}^\text{1}$, Cameron J. Lerch${}^\text{1}$, Marvin Chanc{\'a}n${}^\text{1}$, %Hector Castillo${}^\text{1}$, 
Aaron M. Dollar${}^\text{1}$, and Ian Abraham${}^\text{1}$%~\IEEEmembership{Staff,~IEEE,}
        % <-this % stops a space
