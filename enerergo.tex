...
\end{equation}
where $R\in\mathbb{R}$ is the single resistor measured in ohms in Fig.~\ref{fig:thevenin}, and $V$ is the open circuit voltage. %It is a function of the battery SoC and can be retrieved from the %battery's 
