...
\noindent
The problem addressed in this work is that of exploring a bounded space with multiple agents, continuously, and proportionally to a spatial distribution. 
...
An OCP that selects an ergodic metric that satisfies the battery SoC domain and always keeps at least one agent exploring requires an additional constraint
...
\begin{subequations}\label{eq:ocpfinal}\small\begin{align}
  ...
  \text{ s.t. }{}^1\hspace*{-.2ex}\dot{\mathbf{q}}&(t)\hspace*{-.2ex}=\hspace*{-.2ex}f_1({}^1\hspace*{-.2ex}\mathbf{q}(t),{}^1\hspace*{-.2ex}\mathbf{u}(t)),\dots,{}^n\hspace*{-.4ex}\dot{\mathbf{q}}(t)\hspace*{-.2ex}=\hspace*{-.2ex}f_n({}^n\hspace*{-.4ex}\mathbf{q}(t),{}^n\hspace*{-.4ex}\mathbf{u}(t)),\\
